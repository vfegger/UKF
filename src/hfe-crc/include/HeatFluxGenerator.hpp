...
public:
    HFG_CRC(unsigned Lr_in, unsigned Lth_in, unsigned Lz_in, unsigned Lt_in, double Sr_in, double Sth_in, double Sz_in, double St_in, double T0_in, double Q0_in, double Tamb0_in, double Amp_in, double r0_in, double h_in, PointerType type_in, PointerContext context_in);
